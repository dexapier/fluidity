...
class NextActionDemo(gtk.Window):
    def __init__(self):
        ...
        next_actions.append(NextAction(False, "Study Gtk API", 2, "@Programming"))
        next_actions.append(NextAction(False, "Read Library Book", 3, "@Leisure"))
        next_actions.append(NextAction(True, "Android", 3, "@Programming"))
...
def _formatDataStore(next_actions):
    ...
    for na in next_actions:
        liststore.append(na._convert_to_list())
    return liststore

...
_HACK_CONTEXT = descriptor.Descriptor(
  name='HACK_Context',
  full_name='org.solemnsilence.fluidity.model.HACK_Context',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    descriptor.FieldDescriptor(
      name='uuid', full_name='org.solemnsilence.fluidity.model.HACK_Context.uuid', index=0,
      ...
      options=None),
    descriptor.FieldDescriptor(
      name='name', full_name='org.solemnsilence.fluidity.model.HACK_Context.name', index=1,
...
DESCRIPTOR.message_types_by_name['HACK_Context'] = _HACK_CONTEXT
...
class HACK_Context(message.Message):
  __metaclass__ = reflection.GeneratedProtocolMessageType
  DESCRIPTOR = _HACK_CONTEXT
  
  # @@protoc_insertion_point(class_scope:org.solemnsilence.fluidity.model.HACK_Context)
